...
if (isset($_REQUEST['pages'])) {
    if ($_REQUEST['pages'] === "Form peminjaman") {
...
?>
            ...
            <div class="form-peminjaman">
                <div class="form-peminjaman-value">
                    <div class="table">
                        ...
                        <div class="full-width">
                            <button class="blue-btn" onclick="popUp()">Tambah peminjaman</button>
                        </div>
                    </div>
                    <div class="submit">
            ...
            <script>
                function pub() {
                    ...
                    client.on("connect", function() {
                        ...
                        client.subscribe("eduflex/perpus/pinjam");
                        console.log(data);
                ...
                function ver() {
                    ...
                    function myFunction(item) {
                        bukuuu += "id_buku[]=" + item + "&";
                        publishSend = "assets/api/pinjam.php?" + bukuuu + "rfid=";
